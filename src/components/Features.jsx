            ...
            >
              <div className='flex-1 max-w-full'>
                <div className='relative group'>
                  <div className='absolute inset-0 bg-linear-to-br from-blue-500/20 to-purple-500/20 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-20 transition-all duration-500'/>
                <div className='relative bg-gray-950/50 backdrop-blur-sm border border-grey-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border group-hover:border-blue-600/50 transition-all duration-300'>
                  {/* IDE INTERFACE */}
                    ...
                    <div>
                      <SyntaxHighlighter 
                          ...
                          customStyle={{
                            ...
                            borderRadius: '8px',
                            height: '100%',
                          }}wrapLines={true} lineProps={{ style: { padding: '0 10px' } }}>
                            {feature.codeSnippet}
                      </SyntaxHighlighter>
                    </div>
                  </div>
              ...
              <div className='flex-1 max-w-full'>
                ...
                <h3 className='text-4xl sm:text-3xl lg:text-4xl font-bold mb-4'>{feature.title}</h3>
